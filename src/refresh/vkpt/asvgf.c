...
vkpt_interleave(VkCommandBuffer cmd_buf)
{
	...
	BARRIER_COMPUTE(cmd_buf, qvk.images[VKPT_IMG_TEMPORAL_RR_DIRECT_DIFFUSE]);
	BARRIER_COMPUTE(cmd_buf, qvk.images[VKPT_IMG_TEMPORAL_RR_INDIRECT_DIFFUSE]);
	BARRIER_COMPUTE(cmd_buf, qvk.images[VKPT_IMG_TEMPORAL_RR_DIRECT_SPECULAR]);
	BARRIER_COMPUTE(cmd_buf, qvk.images[VKPT_IMG_TEMPORAL_RR_INDIRECT_SPECULAR]);
	BARRIER_COMPUTE(cmd_buf,
		qvk.images[VKPT_IMG_TEMPORAL_RR_DOMINANT_LIGHT_VISIBILITY]);
