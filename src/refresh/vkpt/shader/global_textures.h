...
#define LIST_IMAGES \
	...
	/* FSR Ray Regeneration-compatible compact material resources. */ \
	IMG_DO(TEMPORAL_DENOISER_NORMAL_ROUGHNESS_MATERIAL, 45, R8G8B8A8_UNORM, rgba8, IMG_WIDTH, IMG_HEIGHT ) \
	IMG_DO(TEMPORAL_DENOISER_DIFFUSE_ALBEDO,             46, R8G8B8A8_UNORM, rgba8, IMG_WIDTH, IMG_HEIGHT ) \
	IMG_DO(TEMPORAL_DENOISER_SPECULAR_ALBEDO,            47, R8G8B8A8_UNORM, rgba8, IMG_WIDTH, IMG_HEIGHT ) \
